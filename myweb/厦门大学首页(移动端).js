var hrefbase="https://gitee.com/huting2019/myweb/raw/master/myweb/",
...
nav1.addEventListener("touchend",nav1mouseout);
imginit();
...
function imginit(){
var c;
imgwidth=document.getElementById("canvas1").clientWidth;
imgheight=document.getElementById("canvas1").clientHeight;
for(var i=0,j;i<src.length;i++){

imgset["img"+i].src=src[i];
imgset["img"+i].width=imgwidth;
imgset["img"+i].height=imgheight;
j=i+1;
...
function nav1mouseout(){

 document.getElementById("ul1").style.height="250px";
 ...
 if(index_light==0)
     {
      ...
      //      ctx.clearRect(0,0,imgwidth,imgheight);           
            ctx.drawImage(imgset["img"+x],0,0,imgwidth,imgheight);              
 ...
 else
     {
      ...
      if(indexnow==index_light)
      {
          ...
          ctx=c.getContext("2d");           
          ctx.clearRect(0,0,imgwidth,imgheight);
          ctx.drawImage(imgset["img"+index],0,0,imgwidth,imgheight); 
       }
      else
          if(indexnow<index_light)
             { 
